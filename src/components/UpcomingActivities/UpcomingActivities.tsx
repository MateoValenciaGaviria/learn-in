        ...
        <div className="upcoming-activities">
            ...
            <div className="upcoming-activities__rows-container">
                <div className="upcoming-activities__row">
                    ...
                    <p className="upcoming-activities__info" >Lun. 13 Sep.</p>
                ...
                <div className="upcoming-activities__row">
                    ...
                    <p className="upcoming-activities__info" >Mar. 21 Sep.</p>
                ...
                <div className="upcoming-activities__row">
                    ...
                    <p className="upcoming-activities__info" >Jue. 23 Sep.</p>
