...
export const HomeSchedule: React.FC<ScheduleProps> = ({ daySelected, server }) => {
    ...
    const getCourses = async () => {
        ...
        if (scheduleDay !== "Saturday" && scheduleDay !== "Sunday") {
            ...
            Object.keys(courseObj).map((key: any) => {
                const value = courseObj[key];
                const temporalCourse: ScheduleType = {
                    id: value.id,
                    course: value.course,
                    hours: value.hours
                }
                scheduleList.push(temporalCourse);
            });
    ...
    return (
        <div className="home-schedule">
            ...
            <div className="home-schedule__row-container">
                ...
                <div>
                    <h3 className="home-schedule__no-class"> ¡Hoy no tienes clase!</h3>
                    <p className="home-schedule__emoji">🎉</p>
                </div>}
            </div>
        </div>
    );
