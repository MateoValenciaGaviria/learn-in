    ...
    <div className="home-schedule__row">
        <div className="home-schedule__course-icon">
            ...
            <svg className="home-schedule__svg" width="47" height="57" viewBox="0 0 47 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.44048 0.000244141H5.32857V46.1811H46.625V49.5115H4.99554C3.76933 49.5115 2.7753 50.5055 2.7753 51.7317V51.9537C2.7753 53.1799 3.76933 54.174 4.99553 54.174H46.625V56.8383H4.44048C1.98807 56.8383 0 54.8503 0 52.3979V4.44072C0 1.98831 1.98807 0.000244141 4.44048 0.000244141Z" fill="black" fill-opacity="0.2"/>
