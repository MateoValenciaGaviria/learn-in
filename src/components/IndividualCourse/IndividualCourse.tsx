...
export const IndividualCourse: React.FC<IndividualCourseProps> = ({name, teacherName, progress, calification}) => {
    return (

        <div className="individual-course">
            <h2 className="individual-course__title">{name}</h2>
            ...
            <progress className="individual-course__progress-bar" max="100" value="75"> {progress}% </progress>
            <p className="individual-course__text-progress">75% Completado</p>
            <p>Nota provisional: {calification} <svg className="icon" width="11" height="11" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
