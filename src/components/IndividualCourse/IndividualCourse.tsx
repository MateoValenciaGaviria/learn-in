...
export const IndividualCourse = () => {
    return (
        ...
        <div className="individual-course">
            <h2 className="individual-course__title">Matemáticas</h2>
            ...
            <progress className="individual-course__progress-bar" max="100" value="75"> 70% </progress>
            <p className="individual-course__text-progress">75% Completado</p>
            <p>Nota provisional: 4.2 <svg className="icon" width="11" height="11" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
